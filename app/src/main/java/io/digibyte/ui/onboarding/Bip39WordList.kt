...
/**
 * BIP39 English word list — 2048 words used for mnemonic generation and validation.
...
object Bip39WordList {
    ...
    val words: List<String> = listOf(
        ...
        "exact", "example", "excess", "exchange", "excite", "exclude", "exercise", "exhaust",
        "exhibit", "exile", "exist", "exit", "exotic", "expand", "expire", "explain",
        "expose", "express", "extend", "extra", "eye", "fable", "face", "faculty",
        "faint", "faith", "fall", "false", "fame", "family", "famous", "fan",
        "fancy", "fantasy", "far", "fashion", "fat", "fatal", "father", "fatigue",
        "fault", "favorite", "feature", "february", "federal", "fee", "feed", "feel",
        "feet", "fellow", "felt", "fence", "festival", "fetch", "fever", "few",
        ...
        "hood", "hope", "horn", "hospital", "host", "hour", "hover", "hub",
        "huge", "human", "humble", "humor", "hundred", "hungry", "hunt", "hurdle",
        "hurry", "hurt", "husband", "hybrid", "ice", "icon", "ignore", "ill",
        "illegal", "image", "imitate", "immense", "immune", "impact", "impose", "improve",
        "impulse", "inbox", "income", "increase", "index", "indicate", "indoor", "industry",
        "infant", "inflict", "inform", "inhale", "inject", "inner", "innocent", "input",
        ...
        "keep", "ketchup", "key", "kick", "kid", "kingdom", "kiss", "kit",
        ...
        "library", "license", "life", "lift", "like", "limb", "limit", "link",
        ...
        "lunch", "luxury", "mad", "magic", "magnet", "maid", "main", "mammal",
        "mango", "mansion", "manual", "maple", "marble", "march", "margin", "marine",
        "market", "marriage", "mask", "master", "match", "material", "math", "matter",
        ...
        "mixed", "mixture", "mobile", "model", "modify", "mom", "monitor", "monkey",
        ...
        "nerve", "nest", "never", "news", "next", "nice", "night", "noble",
        ...
        "scale", "scan", "scare", "scatter", "scene", "scheme", "scissors", "scorpion",
        ...
        "shuffle", "shy", "sibling", "siege", "sight", "sign", "silent", "silk",
        "silly", "silver", "similar", "simple", "since", "sing", "siren", "sister",
        "situate", "six", "size", "sketch", "skill", "skin", "skirt", "skull",
        ...
        "social", "sock", "solar", "soldier", "solid", "solution", "solve", "someone",
        ...
        "typical", "ugly", "umbrella", "unable", "uncle", "uncover", "under", "undo",
    ...
    /** Return suggestions matching the given prefix, up to [limit] results. */
    ...
    /** True if this word is in the BIP39 English list. */
