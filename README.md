...
> **Status:** Active development — **v4.0.43**. BIP157/158 is the only sync path (the bloom wire path was removed in v4.0.0), DigiDollar and Taproot are wired end-to-end, own-node pairing shipped. v4.0.43 fixes a regression introduced in v4.0.41 where a single disagreeing peer could mark tens of thousands of blocks permanently unverified, raising a "history gap" warning that no rescan could clear. **[Download APK](https://digiscope.me/downloads/)** · **[Latest GitHub release](https://github.com/JohnnyLawDGB/digibytewallet-android/releases/latest)**
