...
> **Status:** Active development — **v4.0.44**. BIP157/158 is the only sync path (the bloom wire path was removed in v4.0.0), DigiDollar and Taproot are wired end-to-end, own-node pairing shipped. v4.0.44 can repair a "history gap" in place — re-fetching just the block headers under it — instead of requiring a full rebuild from chain. **[Download APK](https://digiscope.me/downloads/)** · **[Latest GitHub release](https://github.com/JohnnyLawDGB/digibytewallet-android/releases/latest)**
