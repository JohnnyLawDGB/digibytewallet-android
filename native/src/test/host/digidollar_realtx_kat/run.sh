#!/usr/bin/env bash
# Golden-vector KAT: decode a real testnet26 DigiDollar transfer with BRDigiDollar.c.
set -euo pipefail
...
clang -w -include stdint.h -I "$CORE_DIR" -I "$CORE_DIR/secp256k1/include" \
    "$SCRIPT_DIR/digidollar_realtx_kat_main.c" \
    ...
    -o "$BUILD_DIR/digidollar_realtx_kat"
"$BUILD_DIR/digidollar_realtx_kat"
